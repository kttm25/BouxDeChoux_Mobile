...
export default function ManageRoom({ navigation, route }: { navigation: any; route: any }) {
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 32 }} style={{ backgroundColor: "#f5f6fa", flex: 1 }}>
                ...
                {childcares.length > 1 && (
                    <View style={{ marginBottom: 20 }}>
                        <Pressable onPress={() => setChildcareDropdownOpen((prev) => !prev)}
                ...
                <View style={{ flexDirection: "row", gap: 16, flexWrap: "wrap" }}>
                    <View style={{ flex: 1, minWidth: 200, backgroundColor: "#1F8A70", borderRadius: 16, padding: 24 }}>
                    ...
                    <View style={{ flex: 1, minWidth: 200, backgroundColor: "#92400e", borderRadius: 16, padding: 24 }}>
